{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOGHz0jgkA0A0dpwgGrAndf",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/patriciagomesb/atividade_ativa_IESB/blob/main/atividadeAtiva.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "RUtNhlepEBBQ",
        "outputId": "2aa3d360-23d1-42db-f40a-f387b2ae18f4"
      },
      "execution_count": null,
      "outputs": [
        {
          ...
          "text": [
            ...
            "\n",
            "--- Produtos Disponíveis ---\n",
            "- Bolo de chocolate | Ingredientes: Ovo, açucar, leite, óleo, chocolate em pó, farinha de trigo e fermento | Preço: R$ 10.50\n",
            "Cliente ganhou 10% de desconto, pois é o mês do seu aniversario (24/05/1998)!\n",
            "Preço original: R$ 10.50 | Desconto: R$ 1.05 | Preço com desconto: R$ 9.45\n",
            "Pedido realizado: Patricia Borges pediu Bolo de chocolate\n",
            "\n",
            "O que você deseja?\n",
            "1 - Cadastrar um produto\n",
            "2 - Cadastrar um cliente\n",
